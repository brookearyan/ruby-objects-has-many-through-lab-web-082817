...
# `@songs` array.
# * The `Genre` class needs an instance method, `#add_song`,
# that takes in an argument of a song and adds that song to
#  the genre's collection of songs. Now you can use the
#   `Genre#add_song` method in the `Song` class' initialize
...
#  that iterates over the genre's collection of songs and
